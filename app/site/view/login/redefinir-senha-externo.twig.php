...
<div class="center">
    ...
    <div style="max-width:500px">
        <h1>Alterar senha</h1>
        <div class="box">
            <form action="{{BASE}}login/updatePasswordExternal" method="post" id="frmAlterarSenhaExterno" onsubmit="return validarRedefinirSenhaExterno();">
                <div class="mt-3">
                    <label for="txtSenha">Senha <span class="small-font">(minímo 7 caracteres)</span></label>
                    <input type="hidden" id="txtToken" name="txtToken" value="{{token}}">
